...
namespace AlarmShell.UnitTests
{
    ...
    public class AlarmInfoTests
    {
        ...
        {
            AlarmInfo alarmInfo = new AlarmInfo(null, new TimeSpan(1, 0, 0));
        ...
        {
            AlarmInfo alarmInfo = new AlarmInfo("Test Alarm", new TimeSpan(1, 0, 0));
        ...
        public void TestValidTimeSpan()
        {
            ...
            AlarmInfo alarmInfo = new AlarmInfo(null, timeSpan);
